...
import image1 from "../images/Madon-project/img1.jpg"
import image2 from "../images/Madon-project/img2.jpg"
import image3 from "../images/Madon-project/img3.jpg"
import image4 from "../images/Madon-project/img4.jpg"
import image5 from "../images/Madon-project/img5.jpg"
import image6 from "../images/Madon-project/img6.jpg"
import image7 from "../images/Madon-project/img7.jpg"
import image8 from "../images/Madon-project/img8.jpg"
import image9 from "../images/Madon-project/img9.jpg"


export default function MadonProject() {
  return (
    <>
    <section className='font-semibold'>
      <section className='bg-[#0a3332] px-10 text-center text-white md:pb-20'>
        <h1 className='py-10 md:pt-20 md:pb-10 md:text-6xl text-4xl'>Madon Project</h1>
      ...
      <section className='mx-10 md:mx-20 mb-10 grid grid-cols-1 md:grid-cols-3 gap-5'>
          ...
          <img src={image8} alt="image8" className='max-h-[250px] rounded-lg mb-4 md:grid-cols-1'/>
          <img src={image9} alt="image9" className='max-h-[250px] rounded-lg mb-4 md:grid-cols-1'/>
      </section>
    </section>
  </>
  )
