...
import image1 from "../images/Festac project/20180320_120419.jpg"
import image2 from "../images/Festac project/20180320_120446.jpg"
import image3 from "../images/Festac project/20180320_130555.jpg"
import image4 from "../images/Festac project/20180320_130600.jpg"


export default function WhiteCastle() {
  return (
    <>
    <section className='font-semibold'>
      <section className='bg-[#0a3332] px-10 text-center text-white md:pb-20'>
        <h1 className='py-10 md:pt-20 md:pb-10 md:text-6xl text-4xl'>White-stone</h1>
