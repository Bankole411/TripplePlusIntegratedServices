...
import image1 from "../images/Wemabod estate Ikeja/img1.jpg"
import image2 from "../images/Wemabod estate Ikeja/img2.jpg"
import image3 from "../images/Wemabod estate Ikeja/img3.jpg"
import image4 from "../images/Wemabod estate Ikeja/img4.jpg"




export default function Wemabod() {
  return (
    <>
    <section className='font-semibold'>
      <section className='bg-[#0a3332] px-10 text-center text-white md:pb-20'>
        <h1 className='py-10 md:pt-20 md:pb-10 md:text-6xl text-4xl'>PTL Towers: Wemabod estate</h1>
      ...
      <section className='mx-10 md:w-[60vw] max-h-[500px] overflow-auto md:mx-auto my-10 bg-[#80808030] p-5'>
       <div className=''>
