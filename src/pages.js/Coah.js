...
import image1 from "../images/coah/IMG20231010121243.jpg"
import image2 from "../images/coah/IMG20231010121704.jpg"
import image3 from "../images/coah/IMG20231010121600.jpg"
import image4 from "../images/coah/IMG20231010121345.jpg"
import image5 from "../images/coah/IMG20231010121308.jpg"
import image6 from "../images/coah/IMG20231010121644.jpg"
import image7 from "../images/coah/IMG20231010121700.jpg"
import image8 from "../images/coah/IMG20231010121549.jpg"


export default function Coah() {
  return (
    <>
      <section className='font-semibold'>
        <section className='bg-[#0a3332] px-10 text-center text-white md:pb-20'>
          <h1 className='py-10 md:pt-20 md:pb-10 md:text-6xl text-4xl'>Coah</h1>
        ...
        <section className='grid gris-cols-1 md:grid-cols-2 mx-5 my-20'>
          ...
          <div className='font-semibold md:max-w-[500px] leading-relaxed'>
            <p className='mb-5 opacity-80'>Our paints swiftly garnered positive acclaim for this versatile complex, blending beige and white to create a visually stunning color burst.</p>
